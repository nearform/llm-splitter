...
- [#262](https://github.com/nearform/llm-splitter/pull/262) [`c79bdcc`](https://github.com/nearform/llm-splitter/commit/c79bdcc50b6ebb36e68718528f71b15325a60f2a) - Rewrite the chunking core.
  ...
  **Fixed**
  ...
  Also: source is now plain JavaScript with JSDoc annotations rather than TypeScript, with `.d.ts` published for TypeScript consumers, and `Chunk` and `SplitOptions` are exported as types.
