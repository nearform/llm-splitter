...
This is a Node.js JavaScript backend project for chunking text for LLM vectorization (types via JSDoc annotations, validated by `tsc`). Prioritize efficient, configurable chunking logic and robust API design.
